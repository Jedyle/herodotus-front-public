	  ...
	  <IonRow color="primary" justify-content-center>
		...
		<IonItem>
		  ...
		  <IonInput
		    ...
		    onIonChange={
		    (e) => {
		      setRegistration({...registration, email: e.detail.value})
		    }}></IonInput>
		</IonItem>		
		...
		<IonItem>
		  ...
		  <IonInput
		    ...
		    onIonChange={
		    (e) => {
		      setRegistration({...registration, username: e.detail.value})
		    }}></IonInput>
		</IonItem>		
		...
		<IonItem>
		  ...
		  <IonInput
		    ...
		    onIonChange={
		    (e) => {
		      setRegistration({...registration, password: e.detail.value})
		    }}></IonInput>
		</IonItem>		
